...
export const ROUTES: readonly RouteDefinition[] = [
  ...
  // ---------- missions ----------
  {
    ...
    status: 'deprecated',
    group: 'missions',
    summary: 'List active missions (retired — 410 Gone)',
    auth: 'none',
    deprecatedReason: 'Missions retired. Use /sell (contributor) + /api/agents/vocalize (generation). Returns 410.',
  },
  {
    method: 'GET',
    ...
    status: 'deprecated',
    group: 'missions',
    summary: 'Get a single mission by id (retired — 410 Gone)',
    auth: 'none',
    deprecatedReason: 'Missions retired. Returns 410.',
  },
  {
    method: 'POST',
    ...
    status: 'deprecated',
    group: 'missions',
    summary: 'Accept a mission for a user (retired — 410 Gone)',
    auth: 'none',
    deprecatedReason: 'Missions retired. Returns 410.',
  },
  {
    ...
    status: 'deprecated',
    group: 'missions',
    summary: 'Submit a recording to a mission (retired — 410 Gone)',
    auth: 'none',
    deprecatedReason: 'Missions retired. Returns 410.',
  },
  {
    ...
    status: 'deprecated',
    group: 'missions',
    summary: 'Create a new mission (retired — 410 Gone)',
    auth: 'none',
    deprecatedReason: 'Missions retired. Returns 410.',
  },
  ...
  // ---------- user ----------
  {
    ...
    status: 'deprecated',
    group: 'user',
    summary: 'Get a user\'s accepted/completed missions (retired — 410 Gone)',
    auth: 'none',
    deprecatedReason: 'Missions retired. Returns 410.',
  },
  {
