...
const AUTH_SECRET = process.env.AUTH_JWT_SECRET || 'VOISSS_DEV_SECRET_DO_NOT_USE_IN_PROD';
const NONCE_SECRET = process.env.AUTH_NONCE_SECRET || 'VOISSS_NONCE_SECRET_DEV';
