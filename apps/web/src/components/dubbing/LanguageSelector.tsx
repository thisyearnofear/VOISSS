    ...
    <div className={`relative ${className}`}>
      ...
      <button
        ...
        style={{
          ...
          border: `1px solid ${isOpen ? "var(--lr-accent)" : "var(--lr-night-line)"}`,
        }}
      >
      ...
      {/* Dropdown Panel */}
      {isOpen && (
        <div className="absolute z-50 w-full mt-2 rounded-lg shadow-xl max-h-96 overflow-hidden" style={{ background: "var(--lr-night-raised)", border: "1px solid var(--lr-night-line)" }}>
          {/* Search Input */}
          <div className="p-3" style={{ borderBottom: "1px solid var(--lr-night-line)" }}>
            <input
              type="text"
              placeholder="Search languages..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full px-3 py-2 rounded-lg text-white text-sm placeholder-gray-400 focus:outline-none" style={{ background: "var(--lr-night)", border: "1px solid var(--lr-night-line)" }}
            />
          </div>
