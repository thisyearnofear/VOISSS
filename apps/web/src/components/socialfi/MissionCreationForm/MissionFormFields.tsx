    ...
    <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onChange("targetDuration", parseInt(e.target.value) || 120)
              }
              min="30"
              max="600"
              className="w-full px-4 py-2 bg-[#2A2A2A] border border-[#3A3A3A] rounded-lg text-white focus:border-[#7C5DFA] focus:outline-none"
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                onChange("expirationDays", parseInt(e.target.value) || 7)
              }
              min="1"
              max="90"
              className="w-full px-4 py-2 bg-[#2A2A2A] border border-[#3A3A3A] rounded-lg text-white focus:border-[#7C5DFA] focus:outline-none"
        ...
        <div className="p-3 bg-[#1A1A1A] border border-[#3A3A3A] rounded-lg space-y-3">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Splits equally across all submissions. Bonus tokens for engagement
              & featured content.
            </p>
          </div>
      ...
      {showAdvanced && (
        <div className="space-y-6 pt-6 border-t border-[#3A3A3A]">
          ...
          <div>
            ...
            >
              ...
              <option value="performance">
                Performance (quality-based bonus)
              </option>
            </select>
          </div>
          ...
          <div>
            <label className="block text-sm font-medium text-white mb-2">
              Total Budget Allocation (optional)
            </label>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Set a maximum budget for this mission. Leave empty for unlimited
              rewards.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Stake tokens to signal confidence. Unlocks 1.5x reward multiplier
              & priority placement.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                checked={
                  formData.qualityCriteria?.transcriptionRequired || false
                }
                onChange={(e) =>
            ...
            <div>
              <label className="block text-xs font-medium text-gray-400 mb-2">
                Minimum audio quality score (optional)
              </label>
              <input
                type="number"
