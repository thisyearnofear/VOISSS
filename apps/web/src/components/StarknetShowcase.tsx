    ...
    <div className="bg-gradient-to-br from-[#1A1A1A] to-[#2A2A2A] border border-[#3A3A3A] rounded-2xl p-8 mb-12">
      <div className="text-center mb-8">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 rounded-full mb-4">
          ...
          <span className="text-sm font-medium text-white">Powered by Starknet</span>
        </div>
        <h2 className="text-3xl font-bold text-white mb-2">Ultra-Low Fees, Ethereum Security</h2>
        <p className="text-gray-400">Experience the future of blockchain with sub-cent transaction costs</p>
      </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-[#0A0A0A] border border-[#2A2A2A] rounded-xl p-4 text-center">
          <div className="flex items-center justify-center mb-2">
            ...
            <span className="text-xl font-bold text-white">{networkStats.gasPrice} ETH</span>
          </div>
        ...
        <div className="bg-[#0A0A0A] border border-[#2A2A2A] rounded-xl p-4 text-center">
          <div className="flex items-center justify-center mb-2">
            ...
            <span className="text-xl font-bold text-white">{networkStats.tps.toLocaleString()}</span>
          </div>
        ...
        <div className="bg-[#0A0A0A] border border-[#2A2A2A] rounded-xl p-4 text-center">
          <div className="flex items-center justify-center mb-2">
            ...
            <span className="text-xl font-bold text-white">{networkStats.blockTime}</span>
          </div>
        ...
        <div className="bg-[#0A0A0A] border border-[#2A2A2A] rounded-xl p-4 text-center">
          <div className="flex items-center justify-center mb-2">
            ...
            <span className="text-xl font-bold text-white">{networkStats.totalTxs.toLocaleString()}</span>
          </div>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-3">
          {contracts.map((contract, index) => (
            <div key={index} className="bg-[#0A0A0A] border border-[#2A2A2A] rounded-lg p-4 flex items-center justify-between">
              <div>
                <h4 className="font-semibold text-white">{contract.name}</h4>
                <p className="text-gray-400 text-sm font-mono">{formatAddress(contract.address)}</p>
              </div>
      ...
      <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 border border-green-500/20 rounded-xl p-6">
        <h3 className="text-xl font-semibold text-white mb-4 text-center">Cost Comparison</h3>
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500">Same transaction, 15,500x cheaper!</p>
          </div>
        </div>
      </div>
    </div>
